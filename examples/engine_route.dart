...
void main() async {
  ...
  engine.get(
    ...
    (ctx) {
      final id = ctx.param('id');
      return ctx.json({'id': id, 'type': 'product'});
    },
    constraints: {
