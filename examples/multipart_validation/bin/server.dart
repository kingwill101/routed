...
void main() async {
  ...
  engine.post('/upload/single', (ctx) async {
    ...
    try {
      ...
      if (file != null) {
        final safeFileName = DateTime.now().millisecondsSinceEpoch.toString() +
      ...
      return ctx.json({'error': 'Validation failed', 'errors': e.errors},
          statusCode: HttpStatus.unprocessableEntity);
    } catch (e) {
      return ctx.json({'error': 'Upload failed', 'message': e.toString()},
