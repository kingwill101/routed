...
1. Give rules clear, descriptive names
2. Provide helpful error messages
3. Handle null values appropriately
4. Document expected input formats
5. Consider performance implications
6. Add unit tests for custom rules
7. Keep validation logic focused and reusable
...
void main() {
  group('PasswordStrengthRule', () {
    final rule = PasswordStrengthRule();
    
    test('accepts valid strong password', () {
      expect(rule.validate('Test123!@'), isTrue);
    });
