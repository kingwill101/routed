...
- [Typed configuration demo](/docs/routed/examples/config-demo) – validate provider-owned configuration before boot and read it through typed lookups.
...
- [Platform with Stem](/docs/routed/examples/platform-with-stem) – build an authenticated task API with typed configuration, idempotency, and an in-memory worker.
