...
description: Use lib/commands.dart to register project-specific routed_cli commands
sidebar_position: 40
---
...
`dart run routed_cli --help`. If a project command reuses a built-in name the CLI
