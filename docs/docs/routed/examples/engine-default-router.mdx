...
The repository ships with [`examples/engine_default_router`](https://github.com/kingwill101/routed/tree/main/examples/engine_default_router), a concise demo that relies solely on the engine’s built-in router. It illustrates how to:
...
> Register the typed providers and middleware used by the application in the
> engine constructor. This keeps the default router and its dependencies
> visible when the sample grows.
