...
If no policy matches a request, it is exempt from rate limiting. You can scope
policies to specific methods and paths, or remove the middleware from selected
routes/groups:
