...
> **New to Inertia?** Follow the [Build a Todo App](/docs/routed/tutorial) tutorial for a hands-on walkthrough.
...
[tutorial](/docs/routed/tutorial#assets-return-404-in-production)
for more details.
