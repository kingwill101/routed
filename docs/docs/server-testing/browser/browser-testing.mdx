...
- `BrowserConfig` controls the default browser, headless mode, logging, proxy, and device overrides. See [BrowserConfig & Devices](/docs/server_testing/browser/browser-config).
...
For more granular configuration options, continue to the [BrowserConfig & Devices](/docs/server_testing/browser/browser-config) guide.
