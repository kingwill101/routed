...
See the dedicated [TestResponse](/docs/server_testing/test-client/test-response) guide for the full API.
...
In server mode you can also reuse the handler with browser automation; see [Browser Testing](/docs/server_testing/browser/browser-testing) for an end-to-end example.
