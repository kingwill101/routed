...
/// of [ValidationFile]. If the value is not a file, the validation will fail.
class FileRule extends ValidationRule {
  ...
  ///
  /// This method checks if the [value] is an instance of [ValidationFile].
  ///
  ...
  bool validate(dynamic value, [List<String>? options]) {
    return value is ValidationFile;
  }
}
...
class MaxFileSizeRule extends ValidationRule {
  ...
  ///
  /// This method checks if the [value] is an instance of [ValidationFile] and if
  ...
  @override
  bool validate(dynamic value, [List<String>? options]) {
    if (value is! ValidationFile || options == null || options.isEmpty) {
      return false;
    }
