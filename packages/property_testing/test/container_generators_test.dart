  ...
  group('Gen.containerOf', () {
    ...
    test('generates Set<String> respecting constraints', () async {
      ...
      final runner = PropertyTestRunner(gen, (set) {
        ...
        expect(set.length,
            greaterThanOrEqualTo(0)); // Can be 0 if all generated are same
    ...
    test('shrinks container by removing elements', () async {
      ...
      expect((result.failingInput as Set<int>).length,
      ...
      expect(
          ...
          lessThanOrEqualTo(
              4)); // Should ideally be <= 3, allow 4 for intermediate shrinks
    });
    ...
    test('shrinks container by shrinking elements', () async {
      ...
      expect((result.failingInput as List<int>).length,
          equals(1)); // Length shouldn't change
