...
class SseEvent {
  ...
  /// The reconnection time to use when attempting to reconnect after a
  /// connection is lost.
  ...
  ///
  /// The [data] parameter is required, while [id], [event], and [retry] are
  /// optional.
...
///
/// This codec provides a way to convert between raw SSE strings and [SseEvent]
/// objects.
class SseCodec extends Codec<SseEvent, String> {
  /// Returns the decoder that converts raw SSE strings into [SseEvent]
  /// objects.
  @override
  Converter<String, SseEvent> get decoder => _SseEventDecoder();

  /// Returns the encoder that converts [SseEvent] objects into raw SSE
  /// strings.
  @override
...
///
/// This class implements the conversion logic from a raw SSE string to an
/// [SseEvent] object.
class _SseEventDecoder extends Converter<String, SseEvent> {
  /// Converts a raw SSE string into an [SseEvent] object.
  ///
  /// The input string is expected to follow the SSE format, with lines
  /// starting with `id:`, `event:`, `retry:`, or `data:`. The method processes
  /// each line and constructs an [SseEvent] object with the extracted values.
  @override
...
///
/// This class implements the conversion logic from an [SseEvent] object to a
/// raw SSE string.
class _SseEventEncoder extends Converter<SseEvent, String> {
  /// Converts an [SseEvent] object into a raw SSE string.
  ///
  /// The method constructs a string following the SSE format, with lines
  /// starting with `id:`, `event:`, `retry:`, or `data:`. Each field of the
  /// [SseEvent] object is processed and added to the resulting string.
  @override
