...
/// Utilities for negotiating response content types based on the `Accept`
/// header.
class ContentNegotiator {
  ...
  /// When the header is absent or no match is found, [defaultType] (or the
  /// first supported value) is used. Returns `null` when no option can satisfy
  /// the header.
