...
/// A Codec that encodes and decodes XML strings to and from
/// `Map<String, dynamic>`.
...
class User implements XmlEncodable, XmlDecodable<User> {
  ...
  /// Creates a [User] instance with the given [name], [age], [emails], and
  /// [isActive] status.
  User({
    this.name = '',
    this.age = -1,
  ...
  /// Converts the [User] instance into a `Map<String, dynamic>` for XML
  /// encoding.
  @override
  Map<String, dynamic> toXml() {
    return {
