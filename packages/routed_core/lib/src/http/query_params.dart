...
class QueryParamsDecoder extends Converter<String, Map<String, dynamic>> {
  ...
  /// - Parses the value into its appropriate type (int, double, bool, list, or
  ///   string).
  @override
...
/// objects that implement [QueryEncodable].
///
...
/// from a map of query parameters. This can be used in more advanced
/// scenarios.
///
...
dynamic _toEncodable(dynamic value) {
  ...
  // If the object has a `toQuery()` method (via the `QueryEncodable`
  // interface), convert it to a Map<String, dynamic> first, then recurse.
...
class QueryParamsEncoder extends Converter<Map<String, dynamic>, String> {
  ...
  /// - First, converts everything to a "plain" map of `String -> String` or
  ///   `String -> List`, etc.
  ...
  String convert(Map<String, dynamic> input) {
    ...
    // First, convert everything to a "plain" map of String->String or
    // String->List, etc.
  ...
  ///
  /// - If the value is `null`, returns an empty string.
  /// - If the value is a list, joins the elements with commas and encodes the
  ///   result.
  ...
  String _encodeValue(dynamic value) {
    ...
    if (value is List) {
      ...
      // Or you might handle them differently if you prefer repeated keys
