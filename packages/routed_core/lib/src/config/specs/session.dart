...
import 'package:routed_core/src/utils/storage_defaults.dart';
import 'package:server_contracts/server_contracts.dart' show Config;
...
class SessionProviderConfig {
  ...
  static String? _normalizeKey(String? raw) {
    ...
    try {
      ...
      final digest = _sha256Digest(decoded);
      return base64.encode(digest);
    } catch (_) {
      final digest = _sha256Digest(utf8.encode(trimmed));
      return base64.encode(digest);
    }
  }
...
Uint8List _sha256Digest(List<int> bytes) {
