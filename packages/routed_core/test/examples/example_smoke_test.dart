...
void main() {
  engineTest('blog example lists posts and accepts creation', (
    engine,
    client,
  ) async {
    ...
    listResponse
        ...
        .assertJson((json) => json.has('posts').countBetween('posts', 1, 100));
  ...
  engineTest('class-based view example supports creation', (
    engine,
    client,
  ) async {
