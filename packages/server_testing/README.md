...
A testing utility package that provides fluent assertions for JSON and HTTP responses. While built for testing the
`routed` package, its core utilities can be used independently in any Dart project.
...
dev_dependencies:
  server_testing:
    path: path_to_package/server_testing
  test: ^1.25.0
```
...
The assertion utilities are designed to be extensible. Feel free to contribute additional assertion methods or
