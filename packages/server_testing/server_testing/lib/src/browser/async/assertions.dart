...
mixin AsyncBrowserAssertions implements BrowserAssertions {
  ...
  @override
  Future<Browser> shouldSee(String text) => assertSee(text);

  /// Laravel Dusk-style alias for [assertDontSee].
  @override
  Future<Browser> shouldNotSee(String text) => assertDontSee(text);

  /// Laravel Dusk-style alias for [assertTitle].
  @override
  Future<Browser> shouldHaveTitle(String title) => assertTitle(title);

  /// Laravel Dusk-style alias for [assertUrlIs].
  @override
  Future<Browser> shouldBeOn(String url) => assertUrlIs(url);

  /// Laravel Dusk-style alias for [assertPresent].
  @override
  Future<Browser> shouldHaveElement(String selector) => assertPresent(selector);

  /// Laravel Dusk-style alias for [assertNotPresent].
  @override
  Future<Browser> shouldNotHaveElement(String selector) =>
      assertNotPresent(selector);

  /// Laravel Dusk-style alias for [assertInputValue].
  @override
  Future<Browser> shouldHaveValue(String selector, String value) =>
      assertInputValue(selector, value);

  /// Laravel Dusk-style alias for [assertChecked].
  @override
  Future<Browser> shouldBeChecked(String selector) => assertChecked(selector);

  /// Laravel Dusk-style alias for [assertEnabled].
  @override
  Future<Browser> shouldBeEnabled(String selector) => assertEnabled(selector);

  /// Laravel Dusk-style alias for [assertDisabled].
  @override
  Future<Browser> shouldBeDisabled(String selector) => assertDisabled(selector);
}
