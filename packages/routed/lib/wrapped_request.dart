...
class WrappedRequest implements HttpRequest {
  ...
  WrappedRequest(this._originalRequest, this._maxRequestSize) {
    _originalSubscription = _originalRequest.listen((List<int> chunk) {
  ...
  StreamSubscription<Uint8List> listen(void Function(Uint8List event)? onData,
    ...
    return _limitedStreamController.stream.cast<Uint8List>().listen(onData,
  ...
  Stream<Uint8List> asBroadcastStream(
    ...
    return _limitedStreamController.stream
        .cast<Uint8List>()
  ...
  Future<Uint8List> firstWhere(bool Function(Uint8List element) test,
      {Uint8List Function()? orElse}) async {
    return _limitedStreamController.stream
        .cast<Uint8List>()
  ...
  @override
  Future<S> fold<S>(
      S initialValue, S Function(S previous, Uint8List element) combine) async {
    return _limitedStreamController.stream
        .cast<Uint8List>()
  ...
  Future<Uint8List> reduce(
      Uint8List Function(Uint8List previous, Uint8List element) combine) async {
